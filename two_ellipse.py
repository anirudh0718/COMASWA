    ...
    while not check_goal_reached(rbts):
        ...
        for i in range(N):          
            ...
            if tt>0:
                ...
                rbts[i].robot_step(obs,roro,i,i,8,L3,weights_rec3,e1,cent['cent_F2'],cent['AF2'])
                rbts1[i].robot_step(obs,roro1,i,i,8,L3,weights_rec3,e1,cent['cent_F1'],cent['AF1'])
